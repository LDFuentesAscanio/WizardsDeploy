...
export async function fetchExperts(): Promise<ExpertCardData[]> {
  // 1) expertos + profesión + skills + tools (SIN filtros por is_currently_working)
  ...
  return experts.map((e) => ({
    ...
    // la traemos por si más adelante la mostras en el modal, pero NO filtramos por esto
